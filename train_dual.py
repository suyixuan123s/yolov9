...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default='weights/gelan-c-det.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='gelan-c.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/coco-ABB.yaml', help='dataset.yaml path')
