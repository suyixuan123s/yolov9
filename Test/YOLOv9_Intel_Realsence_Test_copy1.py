                ...
                for det in pred:  # 处理每个检测结果
                    if len(det):
                        for *xyxy, conf, cls in det:
                            ...
                            # print(f"Bounding box coordinates: {xyxy}")
                            ...
                            #     # 确保 x 和 y 在图像范围内，特别是 y 要小于 depth_image_height - 1
                            ...
                            corner_coordinates = []  # 存储四个角点的坐标信息
                            ...
                            for i, (x, y) in enumerate(corners):
                                ...
                                print(f"Corner {i + 1} 3D coordinates: {camera_xyz_corner}")
                                corner_coordinates.append(camera_xyz_corner)  # 存储角点三维坐标
